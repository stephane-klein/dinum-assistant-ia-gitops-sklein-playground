"""
title: Nos Administrations
author: Camille Andre, Faheem Beg
version: 0.1
Description: Un assistant qui répond à des questions sur les administrations publiques, peut proposer d'utiliser internet via Albert API si nécessaire.
"""
...
PIPELINE_NAME = "Assistant Nos Administrations"
collection_dict = {
...
réponse attenue : 
Peut on avoir des congés pour le mariage d'un membre de famille ?
