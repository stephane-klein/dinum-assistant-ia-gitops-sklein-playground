...
> Suivez simplement les quelques étapes qui vo
us seront indiquées pour générer la synthèse de votre document.*
---
...
📁 Pour commencer, **téléversez** un fichier de votre choix pour débuter l’analyse. test
""",
                            "done": True,
                            "hidden": False,
                        },
